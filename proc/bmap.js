    ...
    x.extend(Dc.prototype, {
        ...
        Ot: function (a) {
            ...
            if (!this.map.Ub() && (a ? this.map.K.u_ = a : a = this.map.K.u_, a))
                for (var c = p, c = "2" == z.pu ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Km[d]; d++)
                    if (e.h_ == o) {
                        b.k.Zb = 18;
    ...
    Fe.prototype = {
        ...
        bv: function (a) {
            if (!(te && 0 !== a.touches.length)) {
                ...
                if (b.Wk) d = b.scale * b.op, d = Math.max(b.options.Vk, d), d = Math.min(b.options.Xp, d), b.op = d / b.scale, b.scale = d, b.x = b.gy - b.gy * b.op + b.x, b.y = b.hy - b.hy * b.op + b.y, b.Nb.style[ke] = "200ms", b.Nb.style[ie] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + Ee, b.Wk = q, b.refresh(), b.options.up && b.options.up.call(b, a);
                else {
                    if (b.rh) {
